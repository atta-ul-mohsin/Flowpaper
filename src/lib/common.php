...
namespace Flowpaper\Lib;
    ...
    Class Common
    {
         ...
         * @return
         */
        public static function arrayToString($result_array)
        {
            reset($result_array);
            $s = "";
            $itemNo = 0;
         ...
         * @return
         */
        public static function getLastWord($myStr)
        {
            $compare = 1;
            $i = 0;
         ...
         * @return
         */
        public static function removeFileName($myStr)
        {
        ...
        /**
         * function validSwfParams
         *
         * @return
         */
        public static function validSwfParams($path, $doc, $page)
        {
        ...
        /**
         * function validPdfParams
         *
         * @return
         */
        public static function validPdfParams($path, $doc, $page)
        {
            return !(basename(realpath($path)) != $doc ||
                strlen($doc) > 255 ||
                strlen($page) > 255 ||
         ...
         * @return
         */
        public static function invalidFilename($fname)
        {
         ...
         * @return
         */
        public static function endOrRespond()
        {
         ...
         * @return
         */
        public static function getForkCommandStart()
        {
         ...
         * @return
         */
        public static function getForkCommandEnd()
        {
            if (PHP_OS == "WIN32" || PHP_OS == "WINNT")
                return "";
            else
         ...
         * @return
         */
        public static function getTotalPages($PDFPath)
        {
        ...
        /**
         * function strip_non_numerics
         *
         * @return
         */
        public static function strip_non_numerics($string)
        {
         ...
         *
         * Description generates a smaller image from the larger resolution image. Based on the work from adaptive-images.com
         * @return
         */
        public static function generateImage($source_file, $cache_file, $resolution, $inputformat, $outformat)
        {
            try {
