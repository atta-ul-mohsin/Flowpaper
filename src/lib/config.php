...
class Config
{
    ...
    {
        return "<br/><br/>Click <a href='http://flowpaper.com/docs_php.jsp'>here</a> for more information on configuring FlowPaper with PHP";
    }
     ...
     * function newConfig
     *
     * Description: if there is no config file return sample config
     * @return
     */
    function newConfig()
    {
